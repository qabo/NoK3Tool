...
begin
  ...
  begin
    ...
    begin
      ...
      KeyLocated := FDataList.LocateKey;
...
begin
  ...
  begin
    ...
    begin
      if DropDownSpecRow.Visible and
        (VarEquals(Field.DataSet.FieldValues[LookupParams.KeyFieldNames], DropDownSpecRow.Value)
        or
...
begin
  ...
  begin
    ...
    for I := 0 to FAxisBars.Count - 1 do
    begin
      if (DataLink.DataSet = nil) or
         (FAxisBars[I].FField <> DataLink.DataSet.FindField(FAxisBars[I].FieldName))
      then
