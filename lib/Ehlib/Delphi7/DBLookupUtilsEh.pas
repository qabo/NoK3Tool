...
begin
  ...
  begin
    ...
    if FLookupInDataField and (TAxisBarEhCrack(FAxisBar).FField <> nil) then
      ...
      FLookupDisplayField := nil;
    FLookupListActive := (Length(FLookupKeyFields) > 0) and (FLookupDisplayField <> nil);
  end;
...
begin
  if FLookupInDataField <> Value then
    if Value then
    begin
    ...
    begin
      ...
      FInternalLookupSource.DataSet := nil;
      UpdateListFields;
    end;
end;
