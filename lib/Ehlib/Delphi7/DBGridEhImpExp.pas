...
var
  ...
  begin
    ...
    begin
      ...
      try
        if SetAsString
          then AxisBar.SetValueAsText(VarToStr(Value))
          else AxisBar.SetValueAsVariant(Value);
      except
        on E: Exception do
        begin
...
begin
  ...
  begin
    ...
    begin
      if (AxisBar.Field <> nil) and AxisBar.Field.Lookup then
      begin
        FDataFields := GetFieldsProperty(AxisBar.Field.Dataset, nil, AxisBar.Field.KeyFields);
        StrList := TStringList.Create;
        try
